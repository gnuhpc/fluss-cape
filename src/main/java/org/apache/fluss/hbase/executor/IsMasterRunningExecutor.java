...
/** Executor for HBase IsMasterRunning RPC method. Always returns true. */
public class IsMasterRunningExecutor implements HBaseOperationExecutor {

    @Override
    public CompletableFuture<HBaseRpcResponse> execute(HBaseRpcRequest request) {
        MasterProtos.IsMasterRunningResponse response =
                MasterProtos.IsMasterRunningResponse.newBuilder().setIsMasterRunning(true).build();
