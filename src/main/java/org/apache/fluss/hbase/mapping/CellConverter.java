...
public class CellConverter {
    ...
    private Object convertToTinyInt(byte[] bytes) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Cannot convert byte array to TINYINT: "
                            + "expected 1 byte or valid numeric string, got "
                            + bytes.length
                            + " bytes");
        }
    }
    ...
    private Object convertToSmallInt(byte[] bytes) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Cannot convert byte array to SMALLINT: "
                            + "expected 2 bytes or valid numeric string, got "
                            + bytes.length
                            + " bytes");
        }
    }
    ...
    private Object convertToInt(byte[] bytes) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Cannot convert byte array to INTEGER: "
                            + "expected 4 bytes or valid numeric string, got "
                            + bytes.length
                            + " bytes (value: '"
    ...
    private Object convertToBigInt(byte[] bytes) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Cannot convert byte array to BIGINT: "
                            + "expected 8 bytes or valid numeric string, got "
                            + bytes.length
                            + " bytes");
        }
    }
    ...
    private Object convertToFloat(byte[] bytes) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Cannot convert byte array to FLOAT: "
                            + "expected 4 bytes or valid numeric string, got "
                            + bytes.length
                            + " bytes");
        }
    ...
    private Object convertToDouble(byte[] bytes) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Cannot convert byte array to DOUBLE: "
                            + "expected 8 bytes or valid numeric string, got "
                            + bytes.length
                            + " bytes");
        }
