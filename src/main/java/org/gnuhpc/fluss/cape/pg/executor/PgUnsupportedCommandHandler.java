...
public class PgUnsupportedCommandHandler implements PgCommandHandler {

    private final String message;

    public PgUnsupportedCommandHandler(String message) {
        this.message = message;
    }

    @Override
    public List<PgBackendMessage> handle(PgSession session, PgFrontendMessage message) {
        return PgErrorResponseFactory.unsupported(this.message);
    }
}
